...
export const CONTENT_TEXT = {
	...
	Interactivity: [
		"The experience does not employ interactive strategies, rendering the participant like a spectator and mimicking the detainees’ lack of choices.",
	...
	Embodiment: [
		...
		"The participant feels like one of the actors on a theater performance’s stage, interacting with assets and helping the protagonists in various tasks.",
